...
final class AppDelegate: NSObject, NSApplicationDelegate, WKUIDelegate, WKNavigationDelegate {
    ...
    func applicationDidFinishLaunching(_ note: Notification) {
        ...
        showStatus("מפעיל את מעקב הכספים…")
    ...
    func buildMenu() {
        ...
        appMenu.addItem(withTitle: "לסגור את החלון (הסנכרון האוטומטי ממשיך ברקע)", action: #selector(NSWindow.performClose(_:)), keyEquivalent: "w")
